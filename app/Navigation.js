...
const navigationTo = (getTo, animationType) => {
    ...
    switch (animationType) {
        ...
        case 'menu_to_game':            // ALUMNA (Tutorial)
            animation_MenuToMain(getTo);
            break;
        
        case 'game_out':                // ALUMNA (Tutorial)
...
const popUpToggle = (getTo, animationType) => {
    ...
    switch (animationType) {
        ...
        case 'resume_modal':                    // ALUMNA (Tutorial)
            animation_PopupContinue(getTo);
            break;
        
        case 'confirm_modal_in':                // ALUMNA (Tutorial)
            animation_ConfirmIn(getTo);
            break;
        
        case 'confirm_modal_out':
            animation_ConfirmOut(getTo);        // ALUMNA (Tutorial)
            animation_PopupContinue(getTo);     // ALUMNA (Tutorial)
            break;
